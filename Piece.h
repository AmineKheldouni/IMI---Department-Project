...
public :
    ...
    double calcul_cout_aux(int temps, int retard, double probabilite, double cout, const vector<bool> &maintenaces, const Avion &a);
    vector<tuple<double,Piece,double,int>> pieces_suivantes(bool action, int retard, int temps, const Avion &a);
};
